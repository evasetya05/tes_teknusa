# Generated by Django 5.2.2 on 2025-06-12 14:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('post_media', '0011_alter_blog_isi_konten_alter_ig_isi_konten_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(choices=[('blog', 'Awareness'), ('ig', 'Interest'), ('thread', 'Desire'), ('linkedin', 'Action')], max_length=20, verbose_name='channel')),
                ...
                ('isi_konten', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', verbose_name='isi konten')),
